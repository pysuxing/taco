...
we also  use another metric derived from $flops$,
...
$E_{avg} = flops / (NT \times cdot \widehat{flops})$,
...
So only the packing workload in one thread, $T_1$, 
...
are given in Figure~\ref{fig:privb}.

\begin{abstract}
  ...
  have been used to effectively exploit the capability of on-chip lastly-recent-used (LRU) caches,
  ...
  eliminate inter-thread cache conflicts in the
  GEMM routines,
  ...
  and shared pseudo-random L2 caches (per every four cores).
  Our experimental results show that conflict misses in both L1 and L2
